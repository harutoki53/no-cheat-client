...
R.RenderStepped:Connect(function()
    -- キー判定の実行 (RightShift, J, K, L, U, N, M)
    if not U:GetFocusedTextBox() then
        ...
        h(Enum.KeyCode.J, actions.aim)
        h(Enum.KeyCode.K, actions.fire)
        h(Enum.KeyCode.L, actions.wall)
        h(Enum.KeyCode.U, actions.mode)
        h(Enum.KeyCode.N, actions.esp)
        h(Enum.KeyCode.M, actions.hide)
    end
